...
# Here the tree does not branch parents when they mutate -- so is not equipped for making phylogenes corresponding
# to neutral mutations: only beneficial mutations
...
class RandomEvo:
    ...
    def take_step(self):
        ...
        # print([n for n in tree.nodes if self.active[n]])
